...
//Construct 1 matrix
Matrix::Matrix(int n, int m, std::string mmm)
{
    name = mmm;
    rows = n;
    cols = m;
...
Matrix::Matrix(Matrix &A, int N, std::string mmm)
{
    name = mmm;
    rows = 1;
    cols = N;
...
Matrix::Matrix(Matrix &A, int N, int K, std::string mmm)
{
    name = mmm;
    rows = A.rows;
    cols = K - N + 1;
...
Matrix::Matrix(std::string s, std::string mmm)
{
    name = mmm;
    int n = 0, m = 0;
    std::ifstream in;
...
//THIS = THIS * B^T;
void Matrix::TRM(Matrix &B, Matrix &C)
{
    int Brows = B.cols, Bcols = B.rows;
    if(cols == Brows)
    {
        for(int i = 0; i < rows; i++)
        {
